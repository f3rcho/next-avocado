          ...
          <Grid.Row>
            ...
            <Grid.Column width={7}>
              ...
              <p>
                ...
                Platzi realizado por{' '}
                <a href='https://twitter.com/corderoddeos'>@corderoddeos</a>
              </p>
              <List horizontal style={{ display: 'flex' }}>
                <List.Item
                  ...
                  style={{ display: 'flex' }}
                  content={
                    <a href='https://twitter.com/corderoddeos'>Twitter</a>
                  }
                />
                <List.Item
                  icon='github'
                  style={{ display: 'flex' }}
                  content={<a href='https://github.com/f3rcho'>GitHub</a>}
                />
              </List>
            </Grid.Column>
          </Grid.Row>
